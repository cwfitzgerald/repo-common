...
This document describes how to publish a new release of `CRATE_NAME`.
...
```
- [Unreleased](https://github.com/OWNER/REPO/compare/vPREVIOUS...HEAD)
```
Update it and add a new entry:
```
- [Unreleased](https://github.com/OWNER/REPO/compare/vX.Y.Z...HEAD)
- [vX.Y.Z](https://github.com/OWNER/REPO/compare/vPREVIOUS...vX.Y.Z)
```
...
Verify:
- [ ] The crate is visible at https://crates.io/crates/CRATE_NAME/X.Y.Z
- [ ] Docs are building at https://docs.rs/CRATE_NAME/X.Y.Z
- [ ] The GitHub release exists at https://github.com/OWNER/REPO/releases/tag/vX.Y.Z
